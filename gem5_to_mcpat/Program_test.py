...
def readWriteConfigValue(configFile):
    ...
    defaultChangedConfigValue["system.number_of_L2s"] = str(noL2s)
    ...
    # sirui: add the following loop for redefine value, some values are missing in original config.json file because of using simple cpu model  
    for no in range(0,noCores):
        defaultChangedConfigValue["system.core"+str(no)+".fetch_width"] = "8"
        defaultChangedConfigValue["system.core"+str(no)+".decode_width"] = "8"
        defaultChangedConfigValue["system.core"+str(no)+".issue_width"] = '8'
        defaultChangedConfigValue["system.core"+str(no)+".commit_width"] = "8"
        defaultChangedConfigValue["system.core"+str(no)+".instruction_buffer_size"] = "64"
        defaultChangedConfigValue["system.core"+str(no)+".instruction_window_size"] = "64"
        defaultChangedConfigValue["system.core"+str(no)+".fp_instruction_window_size"] = "64"
        defaultChangedConfigValue["system.core"+str(no)+".ROB_size"] = "192"
        defaultChangedConfigValue["system.core"+str(no)+".phy_Regs_IRF_size"] = "256"
        defaultChangedConfigValue["system.core"+str(no)+".phy_Regs_FRF_size"] = "256"
        defaultChangedConfigValue["system.core"+str(no)+".store_buffer_size"] = "32"
        defaultChangedConfigValue["system.core"+str(no)+".load_buffer_size"] = "32"
        defaultChangedConfigValue["system.core"+str(no)+".RAS_size"] = "16"
        defaultChangedConfigValue["system.core"+str(no)+".predictor.local_predictor_size"] = "2048"
        defaultChangedConfigValue["system.core"+str(no)+".predictor.local_predictor_entries"] = "2048"
        defaultChangedConfigValue["system.core"+str(no)+".predictor.global_predictor_entries"] = "8192"
        defaultChangedConfigValue["system.core"+str(no)+".predictor.global_predictor_bits"] = "2"
        defaultChangedConfigValue["system.core"+str(no)+".predictor.chooser_predictor_entries"] = "8192"
        defaultChangedConfigValue["system.core"+str(no)+".predictor.chooser_predictor_bits"] = "2"
        defaultChangedConfigValue["system.core"+str(no)+".BTB.BTB_config"] = "4096,16,2,1,1,1"

    for no in range(0,noCores):
        defaultChangedConfigValue["system.cpu"+str(no)+".icache.cache_policy"] = "1" #detalied
        ...
        try:
            ...
            defaultChangedConfigValue["system.cpu" + str(no) + ".icache.throughput"] = (float(
                stats["system.ruby.l1_cntrl" + str(no) + ".L1Icache.demand_accesses"]) + float(
                stats["system.ruby.l1_cntrl" + str(no) + ".L1Icache.demand_hits"]) ) / float(stats["sim_ticks"]) #sirui
        except KeyError:
        ...
        try:
            ...
            #     no) + ".dcache.overall_accesses::total"]) / float(stats["sim_ticks"])
                ...
                stats["system.ruby.l1_cntrl" + str(no) + ".L1Dcache.demand_accesses"]) + float(
                stats["system.ruby.l1_cntrl" + str(no) + ".L1Dcache.demand_hits"]) ) / float(stats["sim_ticks"]) #sirui
        except KeyError:
    ...
    mapping["system.number_of_L2s"] = "system.number_of_L2s" #sirui
    ...
    mapping["system.target_core_clockrate"] = "default" #sirui: change this to default, get the value from template.xml
    ...
    for no in range(0,noCores):
        ...
        # mapping["system.core"+str(no)+".fetch_width"] = "system.cpu"+str(no)+".fetchWidth" # sirui: comment this line, use redefined value instead
        mapping["system.core"+str(no)+".fetch_width"] = "redefine"
        mapping["system.core"+str(no)+".number_instruction_fetch_ports"] = "default"
        # mapping["system.core"+str(no)+".decode_width"] = "system.cpu"+str(no)+".decodeWidth" # sirui: comment this line, use redefined value instead
        mapping["system.core"+str(no)+".decode_width"] = "redefine" 
        # mapping["system.core"+str(no)+".issue_width"] = "system.cpu"+str(no)+".issueWidth" # sirui: comment this line, use redefined value instead
        mapping["system.core"+str(no)+".issue_width"] = "redefine" 
        mapping["system.core"+str(no)+".peak_issue_width"] = "default"
        # mapping["system.core"+str(no)+".commit_width"] = "system.cpu"+str(no)+".commitWidth"
        mapping["system.core"+str(no)+".commit_width"] = "redefine" # sirui: comment this line, use redefined value instead
        ...
        # mapping["system.core"+str(no)+".instruction_buffer_size"] = "system.cpu"+str(no)+".fetchBufferSize" # sirui: comment this line, use redefined value instead
        mapping["system.core"+str(no)+".instruction_buffer_size"] = "redefine" 
        ...
        # mapping["system.core"+str(no)+".instruction_window_size"] = "system.cpu"+str(no)+".numIQEntries" # sirui: comment this line, use redefined value instead
        mapping["system.core"+str(no)+".instruction_window_size"] = "redefine"
        ...
        mapping["system.core"+str(no)+".fp_instruction_window_size"] = "redefine"
        params["system.cpu"+str(no)+".numIQEntries"] = getConfValue("system.cpu"+str(no)+".numIQEntries")/2
        # mapping["system.core"+str(no)+".ROB_size"] = "system.cpu"+str(no)+".numROBEntries"
        mapping["system.core"+str(no)+".ROB_size"] = "redefine"
        ...
        mapping["system.core"+str(no)+".phy_Regs_IRF_size"] = "redefine"
        # mapping["system.core"+str(no)+".phy_Regs_FRF_size"] = "system.cpu"+str(no)+".numPhysFloatRegs"
        mapping["system.core"+str(no)+".phy_Regs_FRF_size"] = "redefine"
        ...
        mapping["system.core"+str(no)+".predictor.local_predictor_size"] = "redefine"
        mapping["system.core"+str(no)+".predictor.local_predictor_entries"] = "redefine"
        mapping["system.core"+str(no)+".predictor.global_predictor_entries"] = "redefine"
        mapping["system.core"+str(no)+".predictor.global_predictor_bits"] = "redefine"
        mapping["system.core"+str(no)+".predictor.chooser_predictor_entries"] = "redefine"
        mapping["system.core"+str(no)+".predictor.chooser_predictor_bits"] = "redefine"
        ...
        mapping["system.core"+str(no)+".icache.icache_config"] = "system.ruby.l1_cntrl"+str(no)+".L1Icache.size,system.ruby.l1_cntrl"+str(no)+".L1Icache.block_size,system.ruby.l1_cntrl"+str(no)+".L1Icache.assoc,system.ruby.l1_cntrl"+str(no)+".L1Icache.bank,system.cpu"+str(no)+".icache.throughput,system.ruby.l1_cntrl"+str(no)+".L1Icache.latency,system.ruby.l1_cntrl"+str(no)+".L1Icache.tags.block_size,system.ruby.l1_cntrl"+str(no)+".L1Icache.cache_policy" #sirui detailed
        ...
        mapping["system.core"+str(no)+".dcache.dcache_config"] = "system.ruby.l1_cntrl"+str(no)+".L1Dcache.size,system.ruby.l1_cntrl"+str(no)+".L1Dcache.block_size,system.ruby.l1_cntrl"+str(no)+".L1Dcache.assoc,system.ruby.l1_cntrl"+str(no)+".L1Dcache.bank,system.cpu"+str(no)+".dcache.throughput,system.ruby.l1_cntrl"+str(no)+".L1Dcache.latency,system.ruby.l1_cntrl"+str(no)+".L1Dcache.tags.block_size,system.ruby.l1_cntrl"+str(no)+".L1Dcache.cache_policy" #sirui detailed
        ...
        # mapping["system.core"+str(no)+".BTB.BTB_config"] = "system.cpu"+str(no)+".branchPred.BTBEntries,system.cpu"+str(no)+".branchPred.BTBTagSize,system.cpu"+str(no)+".branchPred.indirectWays,system.cpu"+str(no)+".branchPred.bank,system.cpu"+str(no)+".branchPred.throughput,system.cpu"+str(no)+".icache.response_latency" #detail
        mapping["system.core"+str(no)+".BTB.BTB_config"] = "redefine"
    ...
    for no in range (0,noL2s):
        mapping["system.L2"+str(no)+".L2_config"] = "system.ruby.l2_cntrl"+str(no)+".L2cache.size,system.ruby.l2_cntrl"+str(no)+".L2cache.tags.block_size,system.ruby.l2_cntrl"+str(no)+".L2cache.assoc,system.ruby.l2_cntrl"+str(no)+".L2cache.bank,system.ruby.l2_cntrl"+str(no)+".L2cache.throughput,system.ruby.l2_cntrl"+str(no)+".L2cache.latency,system.ruby.l2_cntrl"+str(no)+".L2cache.tags.block_size,system.ruby.l2_cntrl"+str(no)+".L2cache.cache_policy"
        mapping["system.L2"+str(no)+".buffer_sizes"] = "system.ruby.l2_cntrl"+str(no)+".L2cache.mshrs,system.ruby.l2_cntrl"+str(no)+".L2cache.mshrs,system.ruby.l2_cntrl"+str(no)+".L2cache.mshrs,system.ruby.l2_cntrl"+str(no)+".L2cache.mshrs"
    ...
    for child in root.iter('param'):                            #look only for 'param' from xml-tree
        ...
        if mapping[name] == "default":                          #If are not changing this 'param'
            continue
        elif mapping[name] == "redefine": # sirui: add this sub-branch for inserting our redefined value
            val = defaultChangedConfigValue[name]
...
def getConfValue(confStr):
    ...
    if confStrArray[2] == "clock":
        ...
        return int (currentConfig*1e12) #sirui
    else:
...
def writeStatValue(mcpatTemplateFile):
    ...
    for no in range(0,noCores):
        ...
        mapping["system.core"+str(no)+".icache.read_accesses"] = "system.ruby.l1_cntrl"+str(no)+".L1Icache.demand_accesses" #sirui
        mapping["system.core"+str(no)+".icache.read_misses"] = "system.ruby.l1_cntrl"+str(no)+".L1Icache.demand_misses" #sirui
        ...
        mapping["system.core"+str(no)+".dcache.read_accesses"] = "system.ruby.l1_cntrl"+str(no)+".L1Dcache.demand_accesses" #sirui detail
        mapping["system.core"+str(no)+".dcache.write_accesses"] = "system.ruby.l1_cntrl"+str(no)+".L1Dcache.demand_hits" #sirui detail
        mapping["system.core"+str(no)+".dcache.read_misses"] = "system.ruby.l1_cntrl"+str(no)+".L1Dcache.demand_misses" #sirui
        mapping["system.core"+str(no)+".dcache.write_misses"] = "system.ruby.l1_cntrl"+str(no)+".L1Dcache.demand_misses" #sirui
    ...
    for no in range(0,noL2s):
        ...
        mapping["system.L2"+str(no)+".read_accesses"] = "system.ruby.l2_cntrl"+str(no)+".L2cache.demand_accesses"
        mapping["system.L2"+str(no)+".write_accesses"] = "system.ruby.l2_cntrl"+str(no)+".L2cache.demand_hits"
        if noCores == 1:
            try:
        ...
        mapping["system.L2"+str(no)+".read_misses"] = "system.ruby.l2_cntrl"+str(no)+".demand_misses"
    ...
    stats["system.mc.memory_accesses"] = stats["system.mem_ctrls.num_reads::total"] + stats["system.mem_ctrls.num_writes::total"]
